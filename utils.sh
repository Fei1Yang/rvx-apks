...
--keystore-entry-password=$KEYSTORE_ENTRY_PASSWORD --keystore-password=$KEYSTORE_PASSWORD --signer=$SIGNER --keystore-entry-alias=$KEYSTORE_ENTRY_ALIAS $patcher_args"
